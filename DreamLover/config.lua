return {
    ...
    DefaultSettings = {
        ...
        { SettingType = "Toggle", Key = "Rel_AdoptiveParent", GroupName = "关系过滤", DisplayName = "<color=#8B8049>义父义母</color>", Description = "允许太吾的义父义母追求太吾", DefaultValue = false },
        { SettingType = "Toggle", Key = "Rel_AdoptiveChild", GroupName = "关系过滤", DisplayName = "<color=#8B8049>义子义女</color>", Description = "允许太吾的义子义女追求太吾", DefaultValue = false },
