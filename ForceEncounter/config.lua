return {
    ...
    DefaultSettings = {
        ...
        { SettingType = "Slider", Key = "ForcedFavorabilityPenalty", DisplayName = "强制好感惩罚", Description = "普通强制路线对目标的好感惩罚；太吾村民和部分亲密豁免按该数值的30%计算", MinValue = 0, MaxValue = 30000, StepSize = 100, DefaultValue = 30000 },
